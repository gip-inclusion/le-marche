...
## 2023.08.22
 - [#7d604]: fix geo perimeter flacky test (#869)
 - [#9dc72]: log error only if the user is not responsible (#868)
 - [#31012]: [ADMIN] Affichage des conversations d'une structure (#863)
 - [#d6b75]: Refactoring : séparer Dashboard & Networks (#867)
 - [#d6071]: Dépôt de besoin : envoyer un e-mail à J+30 aux auteurs pour savoir si il y a eu une transaction (#865)
 - [#4f3eb]: Dépôt de besoin : CTA sur les fiches structures (#864)
 - [#5e7fd]: Conversations : améliorer l'affichage admin (#866)
 - [#ff036]: [Inbound Parsing] Mise à jour des infos pratique des structures  (#861)
 - [#1960d]: Ajout de MTCaptcha sur le formulaire de contact des structures (#862)
 - [#f9033]: [Inbound parsing] Ajout du nom et prénom au formulaire de contact des structures (#858)
 - [#e3ae8]: Admin : possibilité d'ajuster l’incrémentalité d'un besoin (#859)
 - [#91ff8]: Dépendances : mettre à jour le repo pointant vers raphodn (#860)
 - [#b3c63]: Admin : répare l'affichage des vues avec fieldset (#823)
 - [#74627]: Partenaires besoins : admin : pouvoir chercher par e-mail (#852)
 - [#0d939]: Partenaires besoins : pouvoir indiquer des notes dans l'admin (#851)
 - [#61171]: Affichage des erreurs dans les tests, même en parallèle (#853)
 - [#8c0c7]: Conversations : utiliser send_mail au lieu de EmailMultiAlternatives (#857)
 - [#8424e]: Conversations : améliorer l'affichage dans l'admin (#856)
 - [#77ad2]: fix html display #854
 - [#df9f9]: [Inbound Parsing 4] Migrer vers ShortUUIDField (#854)
 - [#616df]: display pretty messages of conversation (#855)
 - [#69b1d]: [Inbound parsing 3] Ajout d'un formulaire de contact (#843)
 - [#346fe]: Inbound Parsing: fix serializer for incoming data #842
 - [#52dcc]: [Inbound Parsing 2]Enregistrer les records d'inbound parsing (#842)
 - [#b2a33]: Initialiser l'Email inbound Parsing  (#840)
 - [#45bf4]: Note : importer depuis Hubspot (#848)
 - [#097ed]: Note : utiliser CKEditor dans l'admin (#849)
 - [#5ca69]: Note : afficher et filtrer par content_type dans l'admin (#850)
 - [#cb8bd]: Utilisateurs : pouvoir indiquer des notes dans l'admin (#846)
 - [#fcec9]: Structures : pouvoir indiquer des notes dans l'admin (#847)
 - [#c5f6f]: Dépôt de besoin : pouvoir indiquer des notes dans l'admin (#845)
 - [#ab199]: Note : ajout du champ generic foreign key (#844)
 - [#5baee]: Dépôt de besoin : Admin : filtres par source et par montant (#841)
 - [#39ff1]: Nouveau modèle pour indiquer des notes (#836)
 - [#e1c95]: [Mailing listes] Segmenter l’onboarding des acheteurs selon l’inscription (#839)
 - [#1a132]: Hotfix: Siae export command (using SiaeFilterForm). ref #815
 - [#4a469]: Fix stuff on company email_domain_list script. ref #830
 - [#a445b]: Dépôt de besoin : définir une date de publication (#829)
 - [#ff713]: Rechercher un prestataire : ajout du filtre sur les certifications (#837)
 - [#d8215]: Tableau de bord : répare les URLs des ressources (#835)
 - [#3e031]: Entreprise : script pour rattacher les utilisateurs en fonction de leur e-mail (#830)
 - [#3f31a]: Recherche avancée : réparer les lenteurs (#833)
 - [#415cd]: remove useless mailjet js script (#832)
 - [#87af2]: Distinguer les besoins provenant de Tally vs le reste de l’API (#828)
 - [#ae2b4]: Hotfix: remove unused perimeters_autocomplete_field.js #800
 - [#fb1d9]: Affichage de la modal pour s'inscrire ou se connecter pour les utilisateurs anonymes (#825)
 - [#a6db7]: try fix tests with dummy cache in test settings (#831)
 - [#29c6e]: Laisser ouvert la recherche avancée si un champs est saisi (#819)
 - [#a6ce4]: Activer les filtres avancées uniquement quand l'utilisateur est connecté (#815)
 - [#67d62]: Wagtail : répare l'affichage des title (#809)
 - [#4c798]: Dépôt de besoin : envoyer la date de clôture dans certains e-mails (#822)
 - [#37118]: Entreprise : améliorations dans l'admin (#824)
 - [#e7d23]: tender siaes : add ca filter to list (#827)
 - [#c2d24]: tender siae - add employees count filter (#826)
 - [#e3be7]: Recherche : filtre avancé sur l'effectif (#816)
 - [#d11aa]: Dépôt de besoin : nouveau champ pour indiquer le montant exact (#821)
 - [#c0449]: Tracker : enrichir les infos des Siae (#820)
 - [#daa51]: Entreprise : nouveau champ pour lister les nom de domaines des e-mails (#817)
 - [#06715]: Améliorations des requêtes "annotate" (#818)
 - [#ece64]: Ajout du driver gecko dans l'image Docker pour les tests selenium (#814)
 - [#b29b7]: Recherche : filtre sur la forme juridique (#812)
 - [#14cab]: Fix migration file name. ref #811
 - [#74dab]: Créer et remplir le nouveau champ Siae.legal_form (#811)
 - [#dae3d]: Ajout du critère chiffre d'affaire à la recherche de partenaire (#810)
 - [#31ccc]: Mise à jour de l'environnement Docker (#807)
 - [#e465a]: API Entreprise : récupérer les formes juridiques (brutes) (#806)
 - [#d9f42]: Dépôt de besoins : Obligé de sauvegarder deux fois un dépôt de besoin pour mettre à jour le nombre de structures (#808)
 - [#3ede2]: Dépôt de besoin -> formulaire : nouvelle étape pour poser des questions (#786)
 - [#d2dad]: Recherche : filtre sur les prestataires avec (ou sans) groupement (#805)
 - [#d55e9]: Fix migration naming. ref #792
 - [#ea04d]: Utiliser un seul fichier d'initialisation pour le filtre autocomplete par périmètre (#800)
 - [#31834]: Nouveau champ Siae.group_count (#792)
 - [#51dde]: Dépôt de besoin: fix de l'écrasement des SiaeTenders par l'admin (#804)
 - [#3e409]: Admin : pouvoir filtrer les besoins par slug (#803)
 - [#67c28]: Mise à jour des dépendances (#802)
 - [#fcebb]: Connexion : améliorer le message pour les nouveaux utilisateurs sans mot de passe (#797)
 - [#b09e6]: Dépôt de besoin : formulaire : répare l'affichage de la localisation sur l'aperçu (#798)
 - [#50605]: Recherche : deux petites modifications (#799)
 - [#dfc9b]: Django 4.2 (#801)
 - [#47796]: Recherche : filtre sur la localisation (#793)
 - [#13b69]: Recherche : filtre sur les prestataires avec (ou sans) référence client (#791)
 - [#73b87]: add siae_kind to TenderSerializer #695
 - [#09f52]: Optimisation des requêtes de sauvegarde des dépôts de besoins (#794)
 - [#deeef]: fix wagtails indexes with depencies fix (#795)
 - [#3c61a]: Pouvoir rattacher une entreprise à un utilisateur (#789)
 - [#b32f4]: Réseaux : nouveau champ pour stocker un logo (#788)
 - [#62915]: Nouveau modèle pour stocker les Entreprises (#787)
 - [#30108]: Dépôt de besoin : e-mail de rappel aux prestataires qui n'ont pas cliqué (J+4) (#785)
 - [#5ea3c]: Dépôt de besoin : e-mail de rappel aux prestataires qui n'ont pas cliqué (J+3) (#784)
 - [#0892f]: Etape 1 de la recherche avancé (#782)
 - [#9dcc5]: update dependencies for security (#790)
 - [#712b0]: add proprety to display etp count (#778)
 - [#22c48]: Structures : quelques petites modifications  (#783)
 - [#b291e]: Dépôt de besoin : filtre géo sur les prestataires concernés & intéressés (#779)
 - [#bd400]: Dépôt de besoin : bugfix sur la liste des prestataires concernés & intéressés (#781)
 - [#a32c1]: Maj du theme itou vers la v0.7.2 (#780)
 - [#9c7ab]: Dépôt de besoin : Fix du bouton sauvegardé en brouillon (#777)
 - [#201eb]: Hotfix: move link in footer. ref #776
 - [#51a22]: Maj du theme itou vers la v0.7.1 et du footer (#776)
 - [#1e688]: Hotfix: fix display & padding after new theme. ref #760
 - [#35c93]: Hotfix: Header button margin. ref #760
 - [#b796d]: Structures : améliorer l'affichage de leur "card" (#775)
 - [#1d1e9]: Dépôt de besoin : ajout du logo du prestataire (#774)
 - [#32197]: Maj du theme itou vers la v0.6.8, du header et de tarte au citron (#760)
 - [#6cf15]: Recherche : Ajout d'un bouton pour réinitialiser le formulaire  (#773)
 - [#d8603]: Hotfix cases Siae without siret. ref #761
 - [#82ec6]: Admin : Fix de l'erreur 500 à la validation des besoins( hubspot api call) (#772)
 - [#d2322]: Labels : récupérer les données de l'API ADEME RGE (#761)
 - [#2c3de]: Labels : récupérer les données d'ESUS (#767)
 - [#d820a]: Labels : récupérer les données de RSEi (#768)
 - [#79873]: Recherche : reformuler l’encart "Pas de temps à perdre" (#771)
 - [#618c4]: Personnaliser l'expérience après le dépôt de besoin (#764)
 - [#9c57c]: Mise à jour de la popup d'authentification (#770)
 - [#9d510]: Labels : nouveaux champs data & logs (#769)
 - [#8b4b9]: Pouvoir rattacher des labels aux structures (v2) (#763)
 - [#f9d06]: create hubspot deal on admin validation (#766)
 - [#4722b]: Dépôt de besoin : filtre sur les prestataires concernés & intéressés (#747)
 - [#80baf]: Hotfix: siae_user.full_name in Siae completion reminder task. Other fixes. ref #753
 - [#b3139]: Tâches automatisées : améliorer les messages Slack (#758)
 - [#8a246]: Connexion : rediriger les acheteurs vers le moteur de recherche (#759)
 - [#94531]: Dépôt de besoin : ajouter le champ 'source' dans l'e-mail de notification (#757)
 - [#7d450]: Renommer le bouton d'action de la dernière étape du dépôt de besoin (#754)
 - [#0929b]: Fiche structure : modification du CTA (#756)
 - [#6a447]: Inscription : rediriger les acheteurs vers le moteur de recherche (#755)
 - [#a6456]: Structures : envoyer un e-mail de rappel aux prestataires qui ont une fiche incomplète (#753)
 - [#4adaa]: Structures : nouveau champ pour logger certaines informations (#752)
 - [#72b40]: Structures : alternative pour filtrer plus simplement par périmètre  (#751)
 - [#5a210]: Header : renommer la solution Valoriser en Auditer (#750)
 - [#fcebc]: Dépôt de besoin : afficher les questions dans la page détail d'un besoin (#749)
 - [#be298]: Dépôt de besoin : cleanup du formulaire (#743)
 - [#3ae18]: Dépôt de besoin : nouveau modèle TenderQuestion (#742)
 - [#a0b9d]: Header : ajout d'un lien vers la recherche (#748)
 - [#71a0d]: Nouveau modèle pour stocker les labels (#746)
 - [#47f7f]: Refactoring : déplacer les constants géographiques (#739)
 - [#c3616]: make email lower on tender save (#741)
 - [#53f64]: Création d'un utilisateur dans l'appel d'api pour la création du dépôt de besoin  (#740)
 - [#c231d]: Move common stuff to utils folder (#738)
 - [#7b5d5]: Admin : améliorer le rendu des CheckboxSelectMultiple (#736)
 - [#ab8c1]: Dépôt de besoin : modification du CTA (#734)
 - [#80bb5]: Dépôt de besoin : afficher le nom de l'entreprise de l'acheteur (#733)
 - [#a6c16]: Ajout de la section "pourquoi faire appel à un prestataire inclusif" dans wagtail (#737)
 - [#24de3]: Hotfix task name in Tendersiae contact click reminder #732
 - [#20274]: Fix parameter name in Tendersiae contact click reminder workflow. Update cron. ref #732
 - [#81401]: Dépôt de besoin : envoyer un e-mail de rappel aux prestataires qui se sont montrés intéressés (#732)
 - [#e5d7a]: Additional fixes on tendersiae contacted reminder workflow. ref #723
 - [#23e9f]: Rename tendersiae_reminders to tendersiae_contacted_reminders for clarification. ref #723
 - [#39783]: API : petite amélioration de la documentation (#731)
 - [#7d8df]: Fix Tender.import_raw_object set in api create. ref #730
 - [#3f916]: add extra data to the tender serializers
 - [#136a6]: Dépôt de besoin : nouveau champ pour stocker les données venant de l'API (#730)
 - [#42855]: TenderSiae: add email_click_reminder queryset. add tests. ref #723
 - [#f3b35]: Hotfix: mismatch in cron commands. ref #723
 - [#a314a]: Dépôt de besoin : envoyer un e-mail de rappel aux prestataires qui n'ont pas cliqué (#723)
 - [#161f8]: Hotfix: remove Newsletter link in footer (modal not working). ref #725
 - [#7db24]: Dépôt de besoin : afficher dans certains cas l'email de Sofiane dans les coordonnées de contact (#728)
 - [#49df2]: Ajout d'une section "Nos fonctionnalités" sur la page d'accueil (#713)
 - [#336b5]: Accessibilité : ajout des title sur les breadcrumbs (#727)
 - [#d2b25]: Header : remplacer Newsletter par un lien vers une ressource (#725)
 - [#db532]: Dépôt de besoin : rendre certains champs facultatifs (#729)
 - [#21adb]: Mise à jour des dépendances (#726)
 - [#c6d4b]: Pouvoir anonymiser des emails (#724)
 - [#910b1]: Refactoring : séparer Dashboard & Favorites (#720)
 - [#ae37e]: Dépôt de besoin : répare l'envoi d'e-mails aux auteurs des besoins incrémentaux (#722)
 - [#aba01]: Dépôt de besoin : légère modification de l'objet de l'email envoyé aux structures (#721)
 - [#c3165]: Dépôt de besoin : changer le CTA en fonction du type de besoin (#717)
 - [#ce9a1]: Fix: escape html tags in tender detail. v2. ref #716
 - [#107e8]: Dashboard : améliore l'UX du formulaire de modification de sa structure (#714)
 - [#95a03]: Reseaux: add badge Nouveauté. ref #709
 - [#b7709]: Fix: escape html tags in tender detail. ref #716
 - [#bb19c]: Réseaux : page intermédiaire avec le détail du besoin (#718)
 - [#cb955]: Réseaux : page détaillée avec la liste des adhérents notifiés par une opportunité donnée (#710)
 - [#1b229]: Réseaux : page avec la liste des opportunités commerciales de ses adhérents (#709)
 - [#e9269]: Home : maj du bandeau "impact" (#719)
 - [#5839b]: Dépôt de besoin : afficher un WYSIWYG pour les champs text (#716)
 - [#cd0dd]: Home : modifier le message du bandeau "impact" (#715)
 - [#10018]: Fix map z-index. Also fix form autocomplete height. ref #653
 - [#b1370]: Recherche : Mise à jour de l'ui de la page de résultat (#563)
 - [#f7f67]: Dépôt de besoin : élargir la liste des structures intéressées (#712)
 - [#84d11]: Flatpages : expliciter les urls pour éviter les conflits avec Wagtail (#711)
 - [#ed03e]: Tableau de bord : ajout d'illustrations (#708)
 - [#1013e]: Tableau de bord : créer une nouvelle section "Favoris" (#703)
 - [#e8edd]: hotfix stats of homepage
 - [#49cb1]: hotfix homepage sections and display alert
 - [#725c4]: Etape 2 de la migration de la page d'accueil vers le cms (#706)
 - [#ebe44]: Migrer la homepage sur wagtail (#696)
 - [#42a39]: Réseau : page d'accueil via son tableau de bord (#705)
 - [#d7333]: Fiche : nouveau bouton vers Annuaire Entreprises (#704)
 - [#2d730]: Header : bouger le bouton "Favoris" dans le menu "Mon espace" (#702)
 - [#d2a07]: API : endpoint pour récupérer la liste des montants des besoins (#701)
 - [#962ee]: API : endpoint pour récupérer la liste des types de besoins (#700)
 - [#92222]: homepage: changer le text du hero
 - [#3f2bc]: API : indiquer la source et le status lors d'un dépôt de besoin (#699)
 - [#5d72f]: API : déposer un besoin avec une localisation et des secteurs (#697)
 - [#a3449]: Correction du poste qui n'était pas enregistré à l'inscription pour les acheteurs (#698)
 - [#b9dc7]: API : pouvoir déposer un besoin d'achat via l'API (#695)
 - [#45ccf]: Ajout d'un script de génération de automatique changelog (#678)
 - [#655cf]: Ajout de la possibilité d'ajouter de la publicité modifiable depuis le backoffice (#690)
 - [#b0ed2]: Maj du theme itou vers la v0.6.1 (#692)
 - [#c3233]: API : ajouter le champ Siae.logo_url (#689)
 ...
 - [#81493]: Quelques fixes & améliorations (#686)
 ...
 - [#5fedc]: Fix forgot Tender CTA button green for anon users. ref #682
 - [#2fe5e]: Small adjustements on tender siae stats. ref #683
 - [#16df1]: Dépôt de besoin : envoyer le mail aux utilisateurs des structures (#674)
 - [#93595]: Dépôt de besoin : renommer la stat siae_interested_list_last_seen_date (#684)
 - [#b73cb]: Dépôt de besoin : séparer les prestataires ciblés & intéressés (#683)
 - [#e351f]: Dépôt de besoin : mettre en vert le bouton "Répondre à cette opportunité" (#682)
 - [#ab8c2]: Dépôt de besoin : cleanup de l'affichage d'un besoin (#681)
 - [#34685]: Dépôt de besoin : renommer l'URL de la liste des structures intéressées (#680)
 ...
 - [#51c6c]: add advice for tender title in general step (#655)
