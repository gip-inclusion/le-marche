...
## [2025.7.0](https://github.com/gip-inclusion/le-marche/compare/v2025.6.0...v2025.7.0) (2026-09-25)
...
* authentification requise pour télécharger la liste de recherche ([#2139](https://github.com/gip-inclusion/le-marche/issues/2139)) ([02d5a5e](https://github.com/gip-inclusion/le-marche/commit/02d5a5eaf72a4c6bab68d95bc545e52230fcbd63))
...
* **siaes:** afficher les coordonnées de la structure aux acheteurs connectés ([#2140](https://github.com/gip-inclusion/le-marche/issues/2140)) ([3f1458c](https://github.com/gip-inclusion/le-marche/commit/3f1458ce9a8082ce9f7a93078eb062a3de14ddfe))
* **siaes:** bannière promotionnelle Les Traiteurs Engagés ([#2137](https://github.com/gip-inclusion/le-marche/issues/2137)) ([a50f321](https://github.com/gip-inclusion/le-marche/commit/a50f32100a02228eeef8569553fc21d0c55f879d))
...
* **tenders:** page besoins inspirants — accès public, secteurs tronqués, tri chronologique ([#2151](https://github.com/gip-inclusion/le-marche/issues/2151)) ([d3825d4](https://github.com/gip-inclusion/le-marche/commit/d3825d4196c96d3a342c1d37730445151538d997))
* **tenders:** page besoins inspirants pour les acheteurs ([#2143](https://github.com/gip-inclusion/le-marche/issues/2143)) ([a7b41ff](https://github.com/gip-inclusion/le-marche/commit/a7b41ffe890f98e90271946a4a60539b0d4ccf35))
...
* **security:** corriger les XSS stockées et durcir le rendu HTML ([#2104](https://github.com/gip-inclusion/le-marche/issues/2104)) ([b3a12e7](https://github.com/gip-inclusion/le-marche/commit/b3a12e7f0a29576a04a072d91c5c97e308071376))
* **siaes:** générer le téléchargement de toute la liste à la volée ([#2146](https://github.com/gip-inclusion/le-marche/issues/2146)) ([efb9cfa](https://github.com/gip-inclusion/le-marche/commit/efb9cfa5805f11046e9d090d598945375626ca3d))
* **stats:** afficher le tableau de bord Metabase via son lien public ([7bd6b4d](https://github.com/gip-inclusion/le-marche/commit/7bd6b4d1968048cc75382f97ca345a73b1eb3fc9))
* **tenders:** corrections d'affichage des pages besoins inspirants (carte CTA + pagination) ([#2150](https://github.com/gip-inclusion/le-marche/issues/2150)) ([8f89767](https://github.com/gip-inclusion/le-marche/commit/8f897674828d0fb151b327762a3e83e50b79cecf))
...
* AJout d'un export à la commande d'import des achats inclusifs ([#1970](https://github.com/gip-inclusion/le-marche/issues/1970)) ([e0fb022](https://github.com/gip-inclusion/le-marche/commit/e0fb022390d6e5c47f04414f03507b32ea39204f))
* Ajout d'un script de suivit des utilisateurs - RGPD ([#2021](https://github.com/gip-inclusion/le-marche/issues/2021)) ([ee4b43e](https://github.com/gip-inclusion/le-marche/commit/ee4b43e20e3a73ee8f27bf0bc5f044a324f9dc74))
...
* **dashboard:** add size, legal form and region breakdowns to inclusive purchase stats ([#1987](https://github.com/gip-inclusion/le-marche/issues/1987)) ([b12113d](https://github.com/gip-inclusion/le-marche/commit/b12113df509816c5d2d46b037c4d1e3cff951ebe))
...
* Lancer les tâche de syncho nexus en asynchrone ([#1907](https://github.com/gip-inclusion/le-marche/issues/1907)) ([ece3293](https://github.com/gip-inclusion/le-marche/commit/ece3293a1b49880b3d471e46736f0f9f83debb71))
...
* Mise à jour de itoutils et amélioration de la synchronisation nexus ([#1905](https://github.com/gip-inclusion/le-marche/issues/1905)) ([04e2815](https://github.com/gip-inclusion/le-marche/commit/04e2815baaaa6a5b60a8223dfafdaec018878915))
...
* Mise en place de la synchronisation des utilisateurs avec Nexus ([#1893](https://github.com/gip-inclusion/le-marche/issues/1893)) ([416d937](https://github.com/gip-inclusion/le-marche/commit/416d937b147fa4546265338a030dc2cec85c74ea))
* Modification de la page partenaires.html ([#1906](https://github.com/gip-inclusion/le-marche/issues/1906)) ([71ed724](https://github.com/gip-inclusion/le-marche/commit/71ed724b9b22acf5fde7aad7c3a55886af87cbb9))
...
* **Part achat inclusif:** Ajout de la répartition QPV/ZRR ([#1929](https://github.com/gip-inclusion/le-marche/issues/1929)) ([0df5013](https://github.com/gip-inclusion/le-marche/commit/0df50130335db47abd372cc39925ecbb17a3826c))
* Politique de suppression automatique des données ([#1931](https://github.com/gip-inclusion/le-marche/issues/1931)) ([18219f8](https://github.com/gip-inclusion/le-marche/commit/18219f8e0877f4c96aba918985892453aa9ad3d2))
...
* rendre les indicateurs du potentiel inclusif cliquables ([#1985](https://github.com/gip-inclusion/le-marche/issues/1985)) ([5d5144b](https://github.com/gip-inclusion/le-marche/commit/5d5144b185f81549ef390e6d8cb1e0889785d6e4))
* Suppression des données personnelles de l'api des SIAEs ([#1954](https://github.com/gip-inclusion/le-marche/issues/1954)) ([8639628](https://github.com/gip-inclusion/le-marche/commit/8639628caa1aeda54a2d290384009aad582e853b))
...
* Utilisation de la date de synchro avec les emplois comme date de dernière modification dans l'API structures ([#1960](https://github.com/gip-inclusion/le-marche/issues/1960)) ([fad8065](https://github.com/gip-inclusion/le-marche/commit/fad80658f0115154fa923571d53bc0d566a9dce0))


### Bug Fixes

* Add missing config for botocore ([d104774](https://github.com/gip-inclusion/le-marche/commit/d104774a227a9f20874352dafb308ca18ea87964))
* Correction d'un autre bug dans les graphiques d'achat inclusifs ([#1935](https://github.com/gip-inclusion/le-marche/issues/1935)) ([6251b11](https://github.com/gip-inclusion/le-marche/commit/6251b115b21216ab56aa21bcba8907d95d54dd89))
* Correction de la redirection suite à la demande de contact d'un besoin d'achat ([#1952](https://github.com/gip-inclusion/le-marche/issues/1952)) ([364d8be](https://github.com/gip-inclusion/le-marche/commit/364d8be3e86d0246e2bcae86e7a112494d83ace5))
...
* Correction du TDB part achat inclusif ([#1930](https://github.com/gip-inclusion/le-marche/issues/1930)) ([98c9c02](https://github.com/gip-inclusion/le-marche/commit/98c9c02babb085d6a0bae11354604c6dc9bd5f55))
...
* Fix boto config again ([29121f0](https://github.com/gip-inclusion/le-marche/commit/29121f07c76ad42f56b3640991d098d725a0689f))
...
* Fix nexus full sync task name ([#1916](https://github.com/gip-inclusion/le-marche/issues/1916)) ([dbef9ae](https://github.com/gip-inclusion/le-marche/commit/dbef9ae88f7643a357526f222b4e3e154ffe6a27))
* Fix s3 config following boto3 update ([df91e2e](https://github.com/gip-inclusion/le-marche/commit/df91e2e856213869079a5e13730e5e47568d7840))
* harden HSTS to 1 year with includeSubDomains and preload ([#1951](https://github.com/gip-inclusion/le-marche/issues/1951)) ([0498bd0](https://github.com/gip-inclusion/le-marche/commit/0498bd0bac2f6ecf124ba6bee686ac48c3975a73))
...
* Remove old slack integration ([3decc05](https://github.com/gip-inclusion/le-marche/commit/3decc0541b9c04840ffafb6c023ce258017e1a15))
...
* Update command arguments in cron sh script ([c2c786d](https://github.com/gip-inclusion/le-marche/commit/c2c786dc1e438ae1ea781b9d68a973703ac57315))
...
* Afficher le nombre de structures locales dans l'analyse de la programmation achat ([#1780](https://github.com/gip-inclusion/le-marche/issues/1780)) ([cb22fea](https://github.com/gip-inclusion/le-marche/commit/cb22fea3787a736b4204144cc41f4f33a1fe2fd2))
...
* Bouton de relance des fournisseurs ([#1781](https://github.com/gip-inclusion/le-marche/issues/1781)) ([bb9b180](https://github.com/gip-inclusion/le-marche/commit/bb9b1809634f148a694ac81d063ca6a736c0073c))
* Bouton santé financière des structures ([#1779](https://github.com/gip-inclusion/le-marche/issues/1779)) ([0cfbc0e](https://github.com/gip-inclusion/le-marche/commit/0cfbc0eb72855745522a1381545fdb692450b7ab))
...
* Compteur vue sur un besoins plus incitatif ([#1757](https://github.com/gip-inclusion/le-marche/issues/1757)) ([c8f6af2](https://github.com/gip-inclusion/le-marche/commit/c8f6af2e6af0b1af9b2aa9629225762e7645dac0))
* **Dépôt de besoin:** Envoi d'un lien direct vers l'export xls des structures ([#1774](https://github.com/gip-inclusion/le-marche/issues/1774)) ([1c0998b](https://github.com/gip-inclusion/le-marche/commit/1c0998b028c9f591aff755bdf0ffe3cf4ef5a121))
* **Entreprise:** Établir des correspondances entre les références clients et les entreprises ([#1754](https://github.com/gip-inclusion/le-marche/issues/1754)) ([63a1641](https://github.com/gip-inclusion/le-marche/commit/63a1641bdc0d6a2999306982106306a1ebdb83d0))
* Filtres sur les achats inclusifs ([#1776](https://github.com/gip-inclusion/le-marche/issues/1776)) ([81b5636](https://github.com/gip-inclusion/le-marche/commit/81b56360f00161d874180d58f5dfa03bdaeb4103))
...
* Onglet "Pas intéressé" pour les projets d'achats acheteurs ([#1797](https://github.com/gip-inclusion/le-marche/issues/1797)) ([2820d55](https://github.com/gip-inclusion/le-marche/commit/2820d55c033df5310c3538369795bba91394c862))
...
* Préselection de champs pour l'export de fournisseurs ([#1795](https://github.com/gip-inclusion/le-marche/issues/1795)) ([93fc76e](https://github.com/gip-inclusion/le-marche/commit/93fc76e43f235b76fb904784edeeb3522042a399))
* Recherche par SIRET des fournisseurs inclusifs ([#1777](https://github.com/gip-inclusion/le-marche/issues/1777)) ([a597b6e](https://github.com/gip-inclusion/le-marche/commit/a597b6ec7747032c2ef48829695a5bb57b5ae1c8))
* Sélection des colonnes exportables ([#1755](https://github.com/gip-inclusion/le-marche/issues/1755)) ([06c2dfe](https://github.com/gip-inclusion/le-marche/commit/06c2dfeac4824e530fd250dd6dd4f96cd2fed5e1))
* **SiaeActivity:** Ajout de plusieurs activités en une validation ([#1687](https://github.com/gip-inclusion/le-marche/issues/1687)) ([fec6aa1](https://github.com/gip-inclusion/le-marche/commit/fec6aa171f618cab4536e6232341b2a787172357))
* **Structure:** Ajout d'un badge "Déjà référencé" sur la liste des structures ciblées par un dépôt de besoin ([#1766](https://github.com/gip-inclusion/le-marche/issues/1766)) ([447a405](https://github.com/gip-inclusion/le-marche/commit/447a405c5d7247f495e89d54e72a6a083f4fefc0))
* **Structure:** Ajout du badge Hosmoz ([#1760](https://github.com/gip-inclusion/le-marche/issues/1760)) ([c9f7125](https://github.com/gip-inclusion/le-marche/commit/c9f71255fc07f1ccfadc53b8afed3a1e0ea49ee0))
...
* **Tenders:** Afficher les fournisseurs locaux ([#1775](https://github.com/gip-inclusion/le-marche/issues/1775)) ([bd9840b](https://github.com/gip-inclusion/le-marche/commit/bd9840ba9211b44f070cba6f15189048b695f6ef))
* **tenders:** Ajout de labels pour les entreprises d'acheteurs ([#1763](https://github.com/gip-inclusion/le-marche/issues/1763)) ([11159d2](https://github.com/gip-inclusion/le-marche/commit/11159d287952c4fc4917b839b366898b02b9fb29))


### Bug Fixes

* **Admin:** Correction sur l'ajout d'une structure ([#1792](https://github.com/gip-inclusion/le-marche/issues/1792)) ([9a248d9](https://github.com/gip-inclusion/le-marche/commit/9a248d9f3bb9fe667427fcb3c6034a363efb658a))
* **Admin:** Corrections rapides dans l'admin ([#1753](https://github.com/gip-inclusion/le-marche/issues/1753)) ([0e664d9](https://github.com/gip-inclusion/le-marche/commit/0e664d9170b52758cdbd57bd6238edbfbbd3d8c8))
* **admin:** Suppression de la possibilité d'ajouter dans l'admin des correspondances entre les références clients et les entreprises ([#1782](https://github.com/gip-inclusion/le-marche/issues/1782)) ([fcc565b](https://github.com/gip-inclusion/le-marche/commit/fcc565b2ef8a7197e07ce188c1ae04a6bf5b62bd))
* Affichage de la carte sur la fiche fournisseur ([#1798](https://github.com/gip-inclusion/le-marche/issues/1798)) ([0e33816](https://github.com/gip-inclusion/le-marche/commit/0e338163852dfb78402f0b3661e0b1944511774f))
* Ajout du template pour les erreurs 429 ([#1769](https://github.com/gip-inclusion/le-marche/issues/1769)) ([9878827](https://github.com/gip-inclusion/le-marche/commit/9878827d0e53961f72402881028aa4a7573ed4fb))
* **API:** correction de la mise en forme de l'accueil API ([#1778](https://github.com/gip-inclusion/le-marche/issues/1778)) ([ac4afb8](https://github.com/gip-inclusion/le-marche/commit/ac4afb81abdd569d6f2995a8660b4f07ef7c44fd))
...
* Bug non bloquant sur la sélection des activités d'un structure ([#1786](https://github.com/gip-inclusion/le-marche/issues/1786)) ([af2e875](https://github.com/gip-inclusion/le-marche/commit/af2e875434434c56d90a29512d4fd93ebe084787))
...
* **Favoris:** Bug lorsque l'on veut supprimer un favoris qui est dans plusieurs liste ([#1768](https://github.com/gip-inclusion/le-marche/issues/1768)) ([aff3aeb](https://github.com/gip-inclusion/le-marche/commit/aff3aeb97df5501eb191fe985097f4e76ebc2d85))
...
* Mauvais lookup pour l'ajout de groupements sur l'admin ([#1756](https://github.com/gip-inclusion/le-marche/issues/1756)) ([c5a9db3](https://github.com/gip-inclusion/le-marche/commit/c5a9db3e975b3a69d638785f3cc087381eb92eb2))
* **Part d'achat inclusif:** correction du problème de performance ([#1783](https://github.com/gip-inclusion/le-marche/issues/1783)) ([31c775f](https://github.com/gip-inclusion/le-marche/commit/31c775f96c8ffacf42ec75124c2fdf17b7e5d3ee))
* **Recherche:** Correction du champs localisation ([#1767](https://github.com/gip-inclusion/le-marche/issues/1767)) ([a0202f1](https://github.com/gip-inclusion/le-marche/commit/a0202f104eb18f32c1c3ae8bfbb2302955101671))
