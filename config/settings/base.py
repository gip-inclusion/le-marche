...
MAILJET_TENDERS_SIAE_INTERESTED_5_TEMPLATE_ID = env.int("MAILJET_TENDERS_SIAE_INTERESTED_5_TEMPLATE_ID", 3867200)
...
MAILJET_TENDERS_USERS_FEEDBACKS_30D_TEMPLATE_ID = env.int("MAILJET_TENDERS_USERS_FEEDBACKS_30D_TEMPLATE_ID", 4017446)
