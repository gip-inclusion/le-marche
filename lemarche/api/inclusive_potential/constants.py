PRESTA_TYPE_MISE_A_DISPOSITION = "Mise à disposition de personnel"
PRESTA_TYPE_PRESTATIONS_SERVICES = "Prestations de services"
PRESTA_TYPE_FABRICATION_BIENS = "Fabrication et commercialisation de biens"
...
PRESTA_TYPE_TO_SIAE_KINDS = {
    PRESTA_TYPE_MISE_A_DISPOSITION: ["AI", "ETTI", "EATT"],
    PRESTA_TYPE_PRESTATIONS_SERVICES: ["EI", "ACI", "EA", "ESAT", "SEP"],
    PRESTA_TYPE_FABRICATION_BIENS: ["EI", "ACI", "EA", "ESAT", "SEP"],
}
