...
class InclusivePotentialViewTests(TestCase):
    def setUp(self):
        ...
        self.siae_1 = SiaeFactory(kind=KIND_INSERTION_LIST[0], api_entreprise_ca=200000)
        self.siae_2 = SiaeFactory(kind=KIND_INSERTION_LIST[1], super_badge=True, ca=1000000, api_entreprise_ca=500000)
    ...
    def test_recommendation_more_than_30_siaes(self):
        ...
        for siae in siaes:
            ...
            self.siae_activity_1.sectors.add(specific_sector)
            self.siae_activity_1.locations.set([self.perimeter_department])
