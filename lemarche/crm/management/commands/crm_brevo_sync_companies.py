...
class Command(BaseCommand):
    ...
    python manage.py crm_brevo_sync_companies --company-type=siae
    python manage.py crm_brevo_sync_companies --company-type=buyer
    python manage.py crm_brevo_sync_companies --company-type=all
    """
    ...
    def handle(
        ...
        **options,
        ...
        self.stdout_info("-" * 80)
        self.stdout_info("Company synchronization script with Brevo CRM...")
    ...
    def _process_single_siae(self, siae, dry_run: bool, max_retries: int):
        ...
        self._sync_siae_with_brevo_if_needed(siae, extra_data_changed, dry_run, max_retries)
