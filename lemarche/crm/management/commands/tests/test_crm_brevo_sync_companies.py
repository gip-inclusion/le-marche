...
class CrmBrevoSyncCompaniesCommandTest(TransactionTestCase):
    ...
    @patch("lemarche.utils.apis.api_brevo.create_or_update_buyer_company")
    @patch("lemarche.utils.apis.api_brevo.create_or_update_company")
    def test_sync_recently_updated_only(self, mock_siae_api, mock_buyer_api):
    ...
    @patch("lemarche.utils.apis.api_brevo.create_or_update_buyer_company")
    @patch("lemarche.utils.apis.api_brevo.create_or_update_company")
    def test_api_error_handling(self, mock_siae_api, mock_buyer_api):
        """Test proper error handling when API calls fail."""
        # Mock APIs to raise exceptions
        mock_siae_api.side_effect = Exception("SIAE API Error")
        mock_buyer_api.side_effect = Exception("Buyer API Error")
    ...
    @patch("lemarche.utils.apis.api_brevo.create_or_update_buyer_company")
    def test_sync_buyer_companies_only(self, mock_api_call):
        """Test synchronization of buyer companies only."""
