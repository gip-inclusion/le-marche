...
class FixturesTest(TestCase):
    def test_flat_fixtures_load_successfully(self):
        ...
        management.call_command("loaddata", "lemarche/fixtures/django/06_networks.json")
        management.call_command("loaddata", "lemarche/fixtures/django/07_siae_networks.json")
        ...
        self.assertTrue(Network.objects.count())
