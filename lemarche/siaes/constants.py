...
# Types éligibles à la clause sociale d'insertion (hors EITI et SEP par prudence)
KIND_CLAUSE_SOCIALE_LIST = [KIND_EI, KIND_ACI, KIND_AI, KIND_ETTI, KIND_EA, KIND_EATT, KIND_ESAT]
