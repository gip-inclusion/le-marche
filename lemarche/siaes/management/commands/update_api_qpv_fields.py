...
class Command(UpdateAPICommand):
    ...
    Usage: ./manage.py update_api_qpv_fields
    Usage: ./manage.py update_api_qpv_fields --limit 10
    Usage: ./manage.py update_api_qpv_fields --force
    Usage: ./manage.py update_api_qpv_fields --limit 100 --no-force
    """
