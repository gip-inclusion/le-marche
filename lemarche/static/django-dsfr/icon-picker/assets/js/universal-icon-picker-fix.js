...
const iconPickerUrl = scriptUrl.origin + scriptUrl.pathname.replace(/\/js\/[^/]+$/, '');
// Doesn't work with ManifestStaticFilesStorage : const iconPickerUrl = document.currentScript.src.replace(/js\/([a-z\.-]+)$/gm, '');
