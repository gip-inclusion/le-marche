...
def expose_settings(request):
    ...
    return {
        ...
        "DASHBOARD_NETWORK_TITLE": settings.DASHBOARD_NETWORK_TITLE,
        "DASHBOARD_NETWORK_SIAE_TITLE": settings.DASHBOARD_NETWORK_SIAE_TITLE,
        "DASHBOARD_NETWORK_TENDER_TITLE": settings.DASHBOARD_NETWORK_TENDER_TITLE,
