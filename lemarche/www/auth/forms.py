...
class SignupForm(UserCreationForm):
    ...
    first_name = forms.CharField(label="Votre prénom", widget=forms.TextInput(attrs={"class": "form-control"}), required=True)
    last_name = forms.CharField(label="Votre nom", widget=forms.TextInput(attrs={"class": "form-control"}), required=True)
    phone = forms.CharField(label="Votre numéro de téléphone", max_length=35, widget=forms.TextInput(attrs={"class": "form-control"}), required=False)
    email = forms.EmailField(label="Votre adresse e-mail", widget=forms.TextInput(attrs={"class": "form-control"}), required=True)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["email"].widget.attrs.update({"placeholder": "Merci de bien vérifier l'adresse saisie.", "class": "form-control"})
